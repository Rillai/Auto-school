    ...
    return <div><div class="categoryB">
        <div className='category_Top container'>
            <div className='category_Links'>
                ...
                <NavLink className="textBlue" to='/category/c'> Категория C</NavLink >
            </div>
            <h1 className='category_h1'>Обучение категории C<br /> в автошколе "Учим на 5+"</h1>
            <div className='category_Bottom'>
                <ul className='category_box'>
                <li className='liflex'><span className='bigFont'>C</span><div className='textblock'>ПРАВА<br /> КАТЕГОРИИ</div></li>
                ...
                <ul className='cost_box'>
                    ...
                    <li className='text'>Профессиональная подготовка<br /> водителей ТС категории &raquo;C&raquo; <br /></li>
                    <li><table className='cost_box_table'>
                        <tr>
                            <td className='bor cost'>12 000</td>
                        </tr>
                        <tr>
                            <td className='bor '>C</td>
                        </tr>
                    </table></li>
