    ...
    return <div><div class="categoryB">
        <div className='category_Top container'>
            <div className='category_Links'>
                ...
                <NavLink className="textBlue" to='/category/a'> Категория A</NavLink >
            </div>
            <h1 className='category_h1'>Обучение категории A<br /> в автошколе "Учим на 5+"</h1>
            <div className='category_Bottom'>
                <ul className='category_box'>
                    <li className='liflex'><span className='bigFont'>A</span><div className='textblock'>ПРАВА<br /> КАТЕГОРИИ</div></li>
                ...
                <ul className='cost_box'>
                    ...
                    <li className='text'>Профессиональная подготовка<br /> водителей ТС категории &raquo;A&raquo;</li>
                    <li><table className='cost_box_table'>
                        <tr>
                            <td className='bor cost'>8000</td>
                            <td className='bor cost'>6000</td>
                        </tr>
                        <tr>
                            <td className='bor '>A</td>
                            <td className='bor'>«М» и  "А1"</td>
                        </tr>
                    </table></li>
