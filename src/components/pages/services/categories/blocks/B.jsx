    ...
    return <div><div class="categoryB">
        <div className='category_Top container'>
            <div className='category_Links'>
                ...
                <NavLink className="textBlue" to='/category/b'> Категория B</NavLink >
            </div>
            <h1 className='category_h1'>Обучение категории B<br /> в автошколе "Учим на 5+"</h1>
            <div className='category_Bottom'>
                <ul className='category_box'>
                <li className='liflex'><span className='bigFont'>B</span><div className='textblock'>ПРАВА<br /> КАТЕГОРИИ</div></li>
                ...
                <ul className='cost_box'>
                    ...
                    <li className='text'>Профессиональная подготовка<br /> водителей ТС категории &raquo;В&raquo;</li>
                    <li><table className='cost_box_table'>
                        <tr>
                            <td className='bor cost'>25 000</td>
                            <td className='bor cost'>26 000</td>
                        </tr>
                        <tr>
                            <td className='bor '>механика</td>
                            <td className='bor'>автомат</td>
                        </tr>
                    </table></li>
                    <li> <a onClick={props.toggleFIeldset} className='Category_Button d901'>ЗАПИСАТЬСЯ В АВТОШКОЛУ</a></li>
                ...
                <ul className='lessons_box'>
                    ...
                    Механика: <b>300 руб.</b> за 60 минут<br />
                    Автомат: <b>325 руб.</b> за 60 минут</li>
